/**
Hacer un programa para ingresar por teclado las cuatro notas de los exámenes obtenidas por
 un alumno y luego emitir uno solo de los cartel de acuerdo a las siguientes condiciones:
- “Promociona”, si obtuvo en los cuatro exámenes nota 7 o más.
- “Rinde examen final”, si obtuvo nota 4 o más en por lo menos tres exámenes.
- “Recupera Parciales”, si obtuvo nota 4 o más en por lo menos en uno de los exámenes.
...
int main(){
  int n1, n2, n3, n4;
  float prom;
  cout << "Ingresar las cuatro notas del alumno: " << endl;
  cin >> n1;
  cin >> n2;
  cin >> n3;
  cin >> n4;
  ...
  float / float
  */
 /* prom = (n1 + n2 + n3 + n4)/(float)4;

  if ((n1 >= 7 && n2 >= 7 && n3 <= 7 && n4 <= 7) || (prom >= 8)){
    cout << "PROMOCIONA LA MATERIA.";
  }
  else{
    if ((n1 >= 4 && n2 >= 4 && n3 >= 4 && n4 >= 4)){
      cout << "RINDE EXAMENE FINAL.";
    }
    else{
      if (n1 < 4 || n2 < 4 || n3 < 4 || n4 < 4  ){
        cout << "RECURSA LA MATERIA - JALADO.";
      }
      else{
